...
if( process.env.DEBUG === 'debug') //debug 标记
  global.DEBUG = true;
...
app.use(require('koa-static')(pathFn.resolve(CONFIG.FRONT_END.public), { maxage : global.DEBUG ? 0 : 24*60*60*1000}))
app.use( mount('/markdown', require('koa-static')(pathFn.join(__project,'markdown-r/assets'),{ maxage : global.DEBUG ? 0 : 24*60*60*1000})));
